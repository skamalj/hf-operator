...
import (
	...
	"github.com/skamalj/hf-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(hfopsv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e3f054fd.kamal.dev",
	...
	if err := (&controller.ModelDownloadReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ModelDownload")
		os.Exit(1)
	}
